//
// THIS FILE IS NO MORE USED AND WILL BE DELETED WHEN I WILL BE COMPLETE WITH Statix-DOM-Patcher.core.js IMPLEMINTATION!!!
//

import log from "./log.util.js";
import StatixDOMPatcher from "../core/Statix-DOM-Patcher.core.js";
...
const shouldElementsAppended = (oldChild, newChild, parent) => isUndefined(oldChild) && !isUndefined(newChild) && !isHTMLText(parent);
...
export default function diff(oldChilds, newChilds, parent) {
	console.time("StatixPathcer.patch()")
	new StatixDOMPatcher(oldChilds, newChilds).patch();
	console.timeEnd("StatixPathcer.patch()")
	...
	// 	if(shouldElementsAppended(oldChild, newChild, parent)) {
